...
def generate_reference_expansion(origin_works_parquet_file_path, all_works2primary_topic_df):
    ...
    works_df = works_df.explode("references").rename(columns={"id": "work_id", "date": "publication_date", "references": "referenced_work_id"})
...
create_works2references_df(origin_works_parquet_file_path, destination_topic_parquet_file_path, all_works2primary_topic_df, do_peek = True, do_print = True)